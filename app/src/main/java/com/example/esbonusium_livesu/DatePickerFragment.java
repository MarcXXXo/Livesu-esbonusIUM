    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) { //quando premiamo ok stiamo assegnando a date
                ...
                if(listener!=null){
                    listener.onDatePickerFragmentOkButton(com.example.esbonusium_livesu.DatePickerFragment.this, date); //genera l'evento che aggiorna i valori
        ...
        builder.setNegativeButton("Annulla", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        if(listener!=null){
                            listener.onDatePickerFragmentCancelButton(com.example.esbonusium_livesu.DatePickerFragment.this);//genera l'evento che aggiorna i valori
                            //della data nella text view
                        }
                    }
                }
